def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.buikstaglaptumorredomentec_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buikstaglaptumorredomentec() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buikstaglaptumorredomentec' ])
    ...
    with process_scenario_object.trombotest_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.trombotest() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'trombotest' ])

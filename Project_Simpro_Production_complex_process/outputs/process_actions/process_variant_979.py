def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.totaalttrijoodthyroninembvradiois_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.totaalttrijoodthyroninembvradiois() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'totaalttrijoodthyroninembvradiois' ])

    with process_scenario_object.tuptakelatentebindingscapgebtbg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.tuptakelatentebindingscapgebtbg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'tuptakelatentebindingscapgebtbg' ])

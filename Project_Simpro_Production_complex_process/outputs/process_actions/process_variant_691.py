def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.antisttegenhepatitisbsurfaceantigee_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antisttegenhepatitisbsurfaceantigee() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antisttegenhepatitisbsurfaceantigee' ])
    ...
    with process_scenario_object.hepatitisbanticoreigm_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.hepatitisbanticoreigm() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'hepatitisbanticoreigm' ])
    ...
    with process_scenario_object.bepalinghepatitisbeantigeen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bepalinghepatitisbeantigeen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bepalinghepatitisbeantigeen' ])

    with process_scenario_object.bepalingantisthepatitisbeantigeen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bepalingantisthepatitisbeantigeen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bepalingantisthepatitisbeantigeen' ])
    ...
    with process_scenario_object.intercconsultklinischradiotherapie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultklinischradiotherapie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultklinischradiotherapie' ])

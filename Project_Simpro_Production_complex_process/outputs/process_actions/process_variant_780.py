def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.neuronspecifiekenolase_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.neuronspecifiekenolase() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'neuronspecifiekenolase' ])
    ...
    with process_scenario_object.ctknie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ctknie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ctknie' ])

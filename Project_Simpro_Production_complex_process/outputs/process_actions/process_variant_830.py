def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.verwisselenvannefrostomiedrain_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.verwisselenvannefrostomiedrain() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'verwisselenvannefrostomiedrain' ])
    ...
    with process_scenario_object.bloedstollingsfactorxiactiviteit_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bloedstollingsfactorxiactiviteit() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bloedstollingsfactorxiactiviteit' ])

    with process_scenario_object.bloedstollingsfactorxiiactiviteit_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bloedstollingsfactorxiiactiviteit() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bloedstollingsfactorxiiactiviteit' ])
    ...
    with process_scenario_object.bloedstollingsfactorixcoagulatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bloedstollingsfactorixcoagulatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bloedstollingsfactorixcoagulatie' ])

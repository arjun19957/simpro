def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.rogelalsassbijdrainageniernefro_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.rogelalsassbijdrainageniernefro() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'rogelalsassbijdrainageniernefro' ])

    with process_scenario_object.echonier_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echonier() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echonier' ])

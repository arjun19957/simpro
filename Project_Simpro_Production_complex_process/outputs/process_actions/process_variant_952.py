def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.ctartenvenpulmonales_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ctartenvenpulmonales() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ctartenvenpulmonales' ])
    ...
    with process_scenario_object.thoraxzuigdrainagebehandelinga_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.thoraxzuigdrainagebehandelinga() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'thoraxzuigdrainagebehandelinga' ])

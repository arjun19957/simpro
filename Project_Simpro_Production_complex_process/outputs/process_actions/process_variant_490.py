def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.mrigrotehersenen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.mrigrotehersenen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'mrigrotehersenen' ])
    ...
    with process_scenario_object.cytologischonderzoekurineniercyste_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekurineniercyste() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekurineniercyste' ])
    ...
    with process_scenario_object.antisttegenacetylcholinereceptoren_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antisttegenacetylcholinereceptoren() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antisttegenacetylcholinereceptoren' ])
    ...
    with process_scenario_object.erytrocyten_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.erytrocyten() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'erytrocyten' ])
    ...
    with process_scenario_object.buffycoat_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buffycoat() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buffycoat' ])

    with process_scenario_object.aspectsupernatant_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.aspectsupernatant() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'aspectsupernatant' ])
    ...
    with process_scenario_object.proteinecactiviteit_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.proteinecactiviteit() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'proteinecactiviteit' ])

    with process_scenario_object.igmanticardiolipinembvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.igmanticardiolipinembvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'igmanticardiolipinembvelisa' ])

    with process_scenario_object.igganticardiolipinembvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.igganticardiolipinembvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'igganticardiolipinembvelisa' ])

    with process_scenario_object.antistspecifiekmbvelisahistonenof_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antistspecifiekmbvelisahistonenof() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antistspecifiekmbvelisahistonenof' ])
    ...
    with process_scenario_object.stollingsfactorviiiactiviteit_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.stollingsfactorviiiactiviteit() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'stollingsfactorviiiactiviteit' ])

    with process_scenario_object.anticoagulanslupusmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.anticoagulanslupusmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'anticoagulanslupusmbvelisa' ])
    ...
    with process_scenario_object.proteinesantigeentotaal_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.proteinesantigeentotaal() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'proteinesantigeentotaal' ])

    with process_scenario_object.proteinesantigeenvrij_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.proteinesantigeenvrij() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'proteinesantigeenvrij' ])

    with process_scenario_object.factoriimutatiembvpcr_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.factoriimutatiembvpcr() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'factoriimutatiembvpcr' ])

    with process_scenario_object.factorvleidenrqmbvdnatest_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.factorvleidenrqmbvdnatest() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'factorvleidenrqmbvdnatest' ])
    ...
    with process_scenario_object.erytrocytentellenelektronisch_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.erytrocytentellenelektronisch() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'erytrocytentellenelektronisch' ])

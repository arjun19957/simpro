def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.onderzoekviapercutaneveneuzekatheter_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.onderzoekviapercutaneveneuzekatheter() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'onderzoekviapercutaneveneuzekatheter' ])

    with process_scenario_object.echografiedopplervjugularis_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echografiedopplervjugularis() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echografiedopplervjugularis' ])

    with process_scenario_object.vendsavenacavainferior_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vendsavenacavainferior() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vendsavenacavainferior' ])

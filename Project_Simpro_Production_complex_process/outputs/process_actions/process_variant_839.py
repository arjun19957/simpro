def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.lymfeklierscintsentinelnodedynamis_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfeklierscintsentinelnodedynamis() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfeklierscintsentinelnodedynamis' ])

    with process_scenario_object.lymfeklierscintsentinelnodevervolg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfeklierscintsentinelnodevervolg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfeklierscintsentinelnodevervolg' ])

    with process_scenario_object.lymfeklierscintsentinelnodemetpro_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfeklierscintsentinelnodemetpro() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfeklierscintsentinelnodemetpro' ])
    ...
    with process_scenario_object.vulvavulvectomieliesblok_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vulvavulvectomieliesblok() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vulvavulvectomieliesblok' ])
    ...
    with process_scenario_object.vulvatherapeutischepunctieaan_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vulvatherapeutischepunctieaan() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vulvatherapeutischepunctieaan' ])
    ...
    with process_scenario_object.blaassuprapubischekatheterinb_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.blaassuprapubischekatheterinb() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'blaassuprapubischekatheterinb' ])

    with process_scenario_object.urethradilatatiemeatus_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.urethradilatatiemeatus() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'urethradilatatiemeatus' ])

    with process_scenario_object.vulvaradvulvectomieoppend_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vulvaradvulvectomieoppend() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vulvaradvulvectomieoppend' ])

    with process_scenario_object.vrwgeslorgplastischeoperatievanvu_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vrwgeslorgplastischeoperatievanvu() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vrwgeslorgplastischeoperatievanvu' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.mritractusurogenitalis_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.mritractusurogenitalis() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'mritractusurogenitalis' ])

    with process_scenario_object.longfunctiespirometrie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.longfunctiespirometrie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'longfunctiespirometrie' ])

    with process_scenario_object.longfunctiestroomvolumecurve_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.longfunctiestroomvolumecurve() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'longfunctiestroomvolumecurve' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.echobuikwand_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echobuikwand() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echobuikwand' ])
    ...
    with process_scenario_object.buikomentumplastiek_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buikomentumplastiek() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buikomentumplastiek' ])

    with process_scenario_object.uterusextirpatieabdominaalme_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.uterusextirpatieabdominaalme() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'uterusextirpatieabdominaalme' ])

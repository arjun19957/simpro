def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.betasubunitbepmbvriahcg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.betasubunitbepmbvriahcg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'betasubunitbepmbvriahcg' ])
    ...
    with process_scenario_object.inbrengenvoedingsoflavagesondeduode_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.inbrengenvoedingsoflavagesondeduode() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'inbrengenvoedingsoflavagesondeduode' ])
    ...
    with process_scenario_object.onderzoekdunnedarmmzduodenum_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.onderzoekdunnedarmmzduodenum() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'onderzoekdunnedarmmzduodenum' ])
    ...
    with process_scenario_object.beademinganesthesieeerstedag_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.beademinganesthesieeerstedag() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'beademinganesthesieeerstedag' ])
    ...
    with process_scenario_object.beademinganesthesietweedetmvijf_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.beademinganesthesietweedetmvijf() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'beademinganesthesietweedetmvijf' ])
    ...
    with process_scenario_object.echopleura_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echopleura() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echopleura' ])
    ...
    with process_scenario_object.intensivecareligdagetotenmete_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intensivecareligdagetotenmete() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intensivecareligdagetotenmete' ])
    ...
    with process_scenario_object.alfaamylase_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.alfaamylase() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'alfaamylase' ])
    ...
    with process_scenario_object.lipase_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lipase() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lipase' ])
    ...
    with process_scenario_object.vancomycinekwnimmunoassay_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vancomycinekwnimmunoassay() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vancomycinekwnimmunoassay' ])
    ...
    with process_scenario_object.intercconsultvervolgklinischchirurg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultvervolgklinischchirurg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultvervolgklinischchirurg' ])

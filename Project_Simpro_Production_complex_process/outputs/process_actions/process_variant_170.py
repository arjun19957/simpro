def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.eiwitbeperktmineralenbeperkt_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.eiwitbeperktmineralenbeperkt() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'eiwitbeperktmineralenbeperkt' ])
    ...
    with process_scenario_object.wervelkolomcervicaal_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.wervelkolomcervicaal() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'wervelkolomcervicaal' ])
    ...
    with process_scenario_object.fenytoinekwantitatief_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.fenytoinekwantitatief() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'fenytoinekwantitatief' ])
    ...
    with process_scenario_object.wervelkolomthoracaal_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.wervelkolomthoracaal() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'wervelkolomthoracaal' ])

    with process_scenario_object.wervelkolomthoracolumbaleovergang_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.wervelkolomthoracolumbaleovergang() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'wervelkolomthoracolumbaleovergang' ])

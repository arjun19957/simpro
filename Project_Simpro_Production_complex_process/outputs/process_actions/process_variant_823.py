def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.echoarteriaecarotissinistra_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echoarteriaecarotissinistra() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echoarteriaecarotissinistra' ])

    with process_scenario_object.echoarteriaecarotisdextra_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echoarteriaecarotisdextra() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echoarteriaecarotisdextra' ])
    ...
    with process_scenario_object.opnamevolgensbarsonie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.opnamevolgensbarsonie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'opnamevolgensbarsonie' ])
    ...
    with process_scenario_object.cytologischonderzoekhersenen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekhersenen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekhersenen' ])

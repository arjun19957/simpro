def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.echobeen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echobeen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echobeen' ])
    ...
    with process_scenario_object.kniemzonderbeen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.kniemzonderbeen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'kniemzonderbeen' ])

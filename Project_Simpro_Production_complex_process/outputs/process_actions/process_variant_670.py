def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.vulvabiopsiepunctiecytologie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vulvabiopsiepunctiecytologie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vulvabiopsiepunctiecytologie' ])
    ...
    with process_scenario_object.lymfsystsentinelnodeprocedureli_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfsystsentinelnodeprocedureli() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfsystsentinelnodeprocedureli' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.blaascystoscopie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.blaascystoscopie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'blaascystoscopie' ])
    ...
    with process_scenario_object.uterusextirpatieabdominaalradi_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.uterusextirpatieabdominaalradi() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'uterusextirpatieabdominaalradi' ])
    ...
    with process_scenario_object.antihepatitiscvirusmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antihepatitiscvirusmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antihepatitiscvirusmbvelisa' ])

    with process_scenario_object.hepatitiscvirusrochehcvrmbvpcr_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.hepatitiscvirusrochehcvrmbvpcr() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'hepatitiscvirusrochehcvrmbvpcr' ])

    with process_scenario_object.antihivmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antihivmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antihivmbvelisa' ])
    ...
    with process_scenario_object.gentamycinekwnimmunoassay_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.gentamycinekwnimmunoassay() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'gentamycinekwnimmunoassay' ])
    ...
    with process_scenario_object.vitaminebmbvchemieluminescentie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitaminebmbvchemieluminescentie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitaminebmbvchemieluminescentie' ])
    ...
    with process_scenario_object.erytrocytenleukocytenverwijderdbestra_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.erytrocytenleukocytenverwijderdbestra() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'erytrocytenleukocytenverwijderdbestra' ])
    ...
    with process_scenario_object.wormeierenuitgebreidvervolg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.wormeierenuitgebreidvervolg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'wormeierenuitgebreidvervolg' ])
    ...
    with process_scenario_object.vitamineb_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitamineb() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitamineb' ])
    ...
    with process_scenario_object.vitamined_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitamined() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitamined' ])
    ...
    with process_scenario_object.vitamineehplcmethode_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitamineehplcmethode() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitamineehplcmethode' ])

    with process_scenario_object.vitaminea_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitaminea() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitaminea' ])

    with process_scenario_object.zink_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.zink() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'zink' ])
    ...
    with process_scenario_object.vitaminebthiamine_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vitaminebthiamine() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vitaminebthiamine' ])
    ...
    with process_scenario_object.urinezuurmeturicaseuvspectrofotome_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.urinezuurmeturicaseuvspectrofotome() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'urinezuurmeturicaseuvspectrofotome' ])
    ...
    with process_scenario_object.nierenrenografielasix_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.nierenrenografielasix() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'nierenrenografielasix' ])

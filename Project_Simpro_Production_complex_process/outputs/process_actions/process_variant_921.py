def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.cytologischonderzoekliquorcerebrosp_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekliquorcerebrosp() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekliquorcerebrosp' ])
    ...
    with process_scenario_object.immunoglobulinemigm_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.immunoglobulinemigm() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'immunoglobulinemigm' ])

    with process_scenario_object.iggindex_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.iggindex() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'iggindex' ])
    ...
    with process_scenario_object.albumineratio_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.albumineratio() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'albumineratio' ])
    ...
    with process_scenario_object.immunoelektroforeseliquornaconcentra_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.immunoelektroforeseliquornaconcentra() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'immunoelektroforeseliquornaconcentra' ])

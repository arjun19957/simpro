def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.blaasbladderwashout_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.blaasbladderwashout() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'blaasbladderwashout' ])
    ...
    with process_scenario_object.duodenuminbrengenvoedingssondein_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.duodenuminbrengenvoedingssondein() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'duodenuminbrengenvoedingssondein' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.tubauterinaexcisieparovarialecyste_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.tubauterinaexcisieparovarialecyste() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'tubauterinaexcisieparovarialecyste' ])
    ...
    with process_scenario_object.echobovenbeen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echobovenbeen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echobovenbeen' ])

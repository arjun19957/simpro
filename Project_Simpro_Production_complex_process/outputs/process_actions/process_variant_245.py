def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.lithium_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lithium() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lithium' ])
    ...
    with process_scenario_object.lithiumspoed_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lithiumspoed() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lithiumspoed' ])

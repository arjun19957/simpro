def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.totaaltthyroxineimmunofluorimetris_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.totaaltthyroxineimmunofluorimetris() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'totaaltthyroxineimmunofluorimetris' ])
    ...
    with process_scenario_object.vaginabiopsiepunctiecytologie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vaginabiopsiepunctiecytologie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vaginabiopsiepunctiecytologie' ])

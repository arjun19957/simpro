def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.cytostaticainfuustherapie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytostaticainfuustherapie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytostaticainfuustherapie' ])
    ...
    with process_scenario_object.echogeleidealsassbijdrainageintrap_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echogeleidealsassbijdrainageintrap() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echogeleidealsassbijdrainageintrap' ])
    ...
    with process_scenario_object.rituximab_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.rituximab() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'rituximab' ])

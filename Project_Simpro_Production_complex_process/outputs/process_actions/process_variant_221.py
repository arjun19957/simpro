def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.cytologischonderzoekvulva_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekvulva() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekvulva' ])
    ...
    with process_scenario_object.ctretroperitoneum_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ctretroperitoneum() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ctretroperitoneum' ])

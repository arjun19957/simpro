def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.cytologischonderzoekendocervix_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekendocervix() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekendocervix' ])
    ...
    with process_scenario_object.unknown_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.unknown() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'unknown' ])

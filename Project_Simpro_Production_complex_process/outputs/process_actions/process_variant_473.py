def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.chlorideionselectief_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.chlorideionselectief() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'chlorideionselectief' ])
    ...
    with process_scenario_object.doxorubicineliposomalcaelyx_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.doxorubicineliposomalcaelyx() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'doxorubicineliposomalcaelyx' ])
    ...
    with process_scenario_object.intercconsultklinischneurologie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultklinischneurologie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultklinischneurologie' ])

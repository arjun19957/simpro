def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.zwangerschapsreactiespoed_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.zwangerschapsreactiespoed() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'zwangerschapsreactiespoed' ])
    ...
    with process_scenario_object.ethanolenzymatischofgaschromatografi_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ethanolenzymatischofgaschromatografi() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ethanolenzymatischofgaschromatografi' ])
    ...
    with process_scenario_object.inwendgeneeskjaarkaartkostenout_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.inwendgeneeskjaarkaartkostenout() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'inwendgeneeskjaarkaartkostenout' ])

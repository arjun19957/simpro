def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.brachytherapieinterstitieelbijzond_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.brachytherapieinterstitieelbijzond() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'brachytherapieinterstitieelbijzond' ])
    ...
    with process_scenario_object.echoonderbuik_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echoonderbuik() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echoonderbuik' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.blaascatheterademeureinbre_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.blaascatheterademeureinbre() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'blaascatheterademeureinbre' ])
    ...
    with process_scenario_object.sikkelcel_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.sikkelcel() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'sikkelcel' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.endoretrogradecholangiografie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.endoretrogradecholangiografie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'endoretrogradecholangiografie' ])

    with process_scenario_object.pyelografieantegraadviapunctie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.pyelografieantegraadviapunctie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'pyelografieantegraadviapunctie' ])

    with process_scenario_object.cystografieretrograad_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cystografieretrograad() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cystografieretrograad' ])

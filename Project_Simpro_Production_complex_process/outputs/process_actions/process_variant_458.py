def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.lymfsystregionalelymfeklierdissec_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfsystregionalelymfeklierdissec() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfsystregionalelymfeklierdissec' ])

    with process_scenario_object.peritoneumomentectomie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.peritoneumomentectomie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'peritoneumomentectomie' ])

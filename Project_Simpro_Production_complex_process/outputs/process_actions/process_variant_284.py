def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.lymfsystlymfadenectomiedmvlaparo_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfsystlymfadenectomiedmvlaparo() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfsystlymfadenectomiedmvlaparo' ])
    ...
    with process_scenario_object.pyelografiewoniertransplantaat_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.pyelografiewoniertransplantaat() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'pyelografiewoniertransplantaat' ])
    ...
    with process_scenario_object.blaasvoorsteenachtersteexent_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.blaasvoorsteenachtersteexent() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'blaasvoorsteenachtersteexent' ])

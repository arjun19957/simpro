def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.buikpunctieascitesontlastend_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buikpunctieascitesontlastend() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buikpunctieascitesontlastend' ])
    ...
    with process_scenario_object.ohvitaminedmbvhplc_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ohvitaminedmbvhplc() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ohvitaminedmbvhplc' ])
    ...
    with process_scenario_object.parathormoonmbvradioisotopen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.parathormoonmbvradioisotopen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'parathormoonmbvradioisotopen' ])
    ...
    with process_scenario_object.perifvatenverwijderenportacath_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.perifvatenverwijderenportacath() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'perifvatenverwijderenportacath' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.lymfsyststageringslymfadenectomie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.lymfsyststageringslymfadenectomie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'lymfsyststageringslymfadenectomie' ])
    ...
    with process_scenario_object.buiklaparoscopiediagnostisc_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buiklaparoscopiediagnostisc() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buiklaparoscopiediagnostisc' ])

    with process_scenario_object.tubauterinareanastomosenasterilisat_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.tubauterinareanastomosenasterilisat() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'tubauterinareanastomosenasterilisat' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.patientnietverschenenngivnoshow_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.patientnietverschenenngivnoshow() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'patientnietverschenenngivnoshow' ])

    with process_scenario_object.maagontledigscintvastvloeibvoeds_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.maagontledigscintvastvloeibvoeds() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'maagontledigscintvastvloeibvoeds' ])

    with process_scenario_object.darmcolonpassagescintcompvervolg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.darmcolonpassagescintcompvervolg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'darmcolonpassagescintcompvervolg' ])
    ...
    with process_scenario_object.echohalswaaronderschildklier_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echohalswaaronderschildklier() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echohalswaaronderschildklier' ])
    ...
    with process_scenario_object.drainageprocedureonderrontgencontrole_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.drainageprocedureonderrontgencontrole() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'drainageprocedureonderrontgencontrole' ])
    ...
    with process_scenario_object.echoenrontgenalsassbijdrainageab_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echoenrontgenalsassbijdrainageab() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echoenrontgenalsassbijdrainageab' ])
    ...
    with process_scenario_object.paclitaxel_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.paclitaxel() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'paclitaxel' ])
    ...
    with process_scenario_object.celkweekenisolatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.celkweekenisolatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'celkweekenisolatie' ])

    with process_scenario_object.antigeendetectiedirectpreparaaths_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antigeendetectiedirectpreparaaths() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antigeendetectiedirectpreparaaths' ])

    with process_scenario_object.antigeendetectiedirectpreparaatvz_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antigeendetectiedirectpreparaatvz() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antigeendetectiedirectpreparaatvz' ])

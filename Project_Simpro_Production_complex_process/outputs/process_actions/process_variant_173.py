def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.cervixportiolasercoagulatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cervixportiolasercoagulatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cervixportiolasercoagulatie' ])
    ...
    with process_scenario_object.vaginascopieexclweefselwegname_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vaginascopieexclweefselwegname() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vaginascopieexclweefselwegname' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.widalagglutinatieyersinia_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.widalagglutinatieyersinia() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'widalagglutinatieyersinia' ])
    ...
    with process_scenario_object.dikkedarmcolonoscopiemetbiopsie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.dikkedarmcolonoscopiemetbiopsie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'dikkedarmcolonoscopiemetbiopsie' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.eiwitspectrumelektroforesekwnbepf_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.eiwitspectrumelektroforesekwnbepf() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'eiwitspectrumelektroforesekwnbepf' ])

    with process_scenario_object.immunoglobulinegigg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.immunoglobulinegigg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'immunoglobulinegigg' ])
    ...
    with process_scenario_object.paraproteinetyperingmbvmonospecifieke_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.paraproteinetyperingmbvmonospecifieke() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'paraproteinetyperingmbvmonospecifieke' ])

    with process_scenario_object.eiwitfractioneringmbvief_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.eiwitfractioneringmbvief() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'eiwitfractioneringmbvief' ])

    with process_scenario_object.immunofixatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.immunofixatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'immunofixatie' ])

    with process_scenario_object.immunoforesenaconcentratie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.immunoforesenaconcentratie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'immunoforesenaconcentratie' ])

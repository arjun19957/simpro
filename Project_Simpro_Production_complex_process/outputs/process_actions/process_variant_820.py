def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.antichlamydiaigambvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antichlamydiaigambvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antichlamydiaigambvelisa' ])
    ...
    with process_scenario_object.antichlamydiaiggmbvindift_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antichlamydiaiggmbvindift() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antichlamydiaiggmbvindift' ])

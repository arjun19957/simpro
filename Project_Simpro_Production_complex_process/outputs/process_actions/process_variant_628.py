def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.oestradiolmbvradioisotopenria_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.oestradiolmbvradioisotopenria() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'oestradiolmbvradioisotopenria' ])
    ...
    with process_scenario_object.ovariumdebulkingovariumcarcinoom_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ovariumdebulkingovariumcarcinoom() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ovariumdebulkingovariumcarcinoom' ])
    ...
    with process_scenario_object.doorlichtingzonderopnamebuik_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.doorlichtingzonderopnamebuik() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'doorlichtingzonderopnamebuik' ])
    ...
    with process_scenario_object.antisttegenhiveofhivc_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antisttegenhiveofhivc() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antisttegenhiveofhivc' ])
    ...
    with process_scenario_object.directondznaarrsvirusantigeenmbv_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.directondznaarrsvirusantigeenmbv() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'directondznaarrsvirusantigeenmbv' ])

    with process_scenario_object.parainfluenzavirusmbvpcr_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.parainfluenzavirusmbvpcr() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'parainfluenzavirusmbvpcr' ])

    with process_scenario_object.humaanmetapneumoviruskwlmbvdnarna_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.humaanmetapneumoviruskwlmbvdnarna() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'humaanmetapneumoviruskwlmbvdnarna' ])

    with process_scenario_object.antigeendetectiembviftinfluenzaa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antigeendetectiembviftinfluenzaa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antigeendetectiembviftinfluenzaa' ])

    with process_scenario_object.antigeendetectiembviftinfluenzab_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antigeendetectiembviftinfluenzab() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antigeendetectiembviftinfluenzab' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.intercconsultklinischchirurgie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultklinischchirurgie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultklinischchirurgie' ])
    ...
    with process_scenario_object.mictiecystouretrografie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.mictiecystouretrografie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'mictiecystouretrografie' ])

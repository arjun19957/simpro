def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.doorlichtingbijniersteenvergruizing_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.doorlichtingbijniersteenvergruizing() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'doorlichtingbijniersteenvergruizing' ])
    ...
    with process_scenario_object.wisselendrainonderrontgencontrole_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.wisselendrainonderrontgencontrole() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'wisselendrainonderrontgencontrole' ])

    with process_scenario_object.pyelografieantegraadviadrain_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.pyelografieantegraadviadrain() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'pyelografieantegraadviadrain' ])

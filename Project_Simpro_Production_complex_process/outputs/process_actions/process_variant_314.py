def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.titratiedirecteantiglobulinetestcoo_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.titratiedirecteantiglobulinetestcoo() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'titratiedirecteantiglobulinetestcoo' ])
    ...
    with process_scenario_object.bloedgroepbepandersdanaboperbloedg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bloedgroepbepandersdanaboperbloedg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bloedgroepbepandersdanaboperbloedg' ])
    ...
    with process_scenario_object.bloedgroepbepalingandersdanabokidd_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bloedgroepbepalingandersdanabokidd() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bloedgroepbepalingandersdanabokidd' ])

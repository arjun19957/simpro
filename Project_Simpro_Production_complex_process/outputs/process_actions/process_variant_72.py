def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.hartresuscitatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.hartresuscitatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'hartresuscitatie' ])

    with process_scenario_object.uterusextirpatieabdomtotaalme_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.uterusextirpatieabdomtotaalme() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'uterusextirpatieabdomtotaalme' ])
    ...
    with process_scenario_object.vrwgeslorgadhesiolysisovariumplus_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vrwgeslorgadhesiolysisovariumplus() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vrwgeslorgadhesiolysisovariumplus' ])

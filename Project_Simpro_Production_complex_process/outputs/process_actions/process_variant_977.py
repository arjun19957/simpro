def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.vrijtmbvriaft_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vrijtmbvriaft() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vrijtmbvriaft' ])
    ...
    with process_scenario_object.vrwgeslorgexcdestructpathafwijkin_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vrwgeslorgexcdestructpathafwijkin() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vrwgeslorgexcdestructpathafwijkin' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.huidtranscutanepoenpcome_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.huidtranscutanepoenpcome() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'huidtranscutanepoenpcome' ])
    ...
    with process_scenario_object.glucosebepalingkwantitatief_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.glucosebepalingkwantitatief() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'glucosebepalingkwantitatief' ])

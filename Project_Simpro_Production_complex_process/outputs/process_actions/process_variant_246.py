def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.vrwgeslorgaspiratieofmicrocurett_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vrwgeslorgaspiratieofmicrocurett() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vrwgeslorgaspiratieofmicrocurett' ])
    ...
    with process_scenario_object.intercconsultklinischinterneziekten_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultklinischinterneziekten() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultklinischinterneziekten' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.alfafoetoproteine_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.alfafoetoproteine() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'alfafoetoproteine' ])
    ...
    with process_scenario_object.kleurproefsabinfeldmanleishmania_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.kleurproefsabinfeldmanleishmania() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'kleurproefsabinfeldmanleishmania' ])

    with process_scenario_object.toxoplasmosembveiatoxoigg_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.toxoplasmosembveiatoxoigg() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'toxoplasmosembveiatoxoigg' ])

    with process_scenario_object.toxoplasmosembveiatoxoigm_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.toxoplasmosembveiatoxoigm() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'toxoplasmosembveiatoxoigm' ])
    ...
    with process_scenario_object.antirubellaiggelisaineenmonster_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antirubellaiggelisaineenmonster() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antirubellaiggelisaineenmonster' ])

    with process_scenario_object.antirubellaigmelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antirubellaigmelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antirubellaigmelisa' ])

    with process_scenario_object.cbrcoxsackiebvirus_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cbrcoxsackiebvirus() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cbrcoxsackiebvirus' ])

    with process_scenario_object.antiparvovirusigofiggantistind_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antiparvovirusigofiggantistind() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antiparvovirusigofiggantistind' ])

    with process_scenario_object.anticytomegalovirusigofiggelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.anticytomegalovirusigofiggelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'anticytomegalovirusigofiggelisa' ])
    ...
    with process_scenario_object.igmastegencmvvirus_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.igmastegencmvvirus() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'igmastegencmvvirus' ])
    ...
    with process_scenario_object.antiparvovirusigmmbvindift_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antiparvovirusigmmbvindift() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antiparvovirusigmmbvindift' ])
    ...
    with process_scenario_object.pijnbestrijdaanleggenpatientcontroll_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.pijnbestrijdaanleggenpatientcontroll() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'pijnbestrijdaanleggenpatientcontroll' ])
    ...
    with process_scenario_object.tubauterinaaanbrengenclipstijdensl_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.tubauterinaaanbrengenclipstijdensl() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'tubauterinaaanbrengenclipstijdensl' ])

    with process_scenario_object.partusklinofpoliklinmetvoorb_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.partusklinofpoliklinmetvoorb() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'partusklinofpoliklinmetvoorb' ])

    with process_scenario_object.sectcaesarmetvoorbehandelingenkra_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.sectcaesarmetvoorbehandelingenkra() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'sectcaesarmetvoorbehandelingenkra' ])
    ...
    with process_scenario_object.cytologischonderzoekdiversen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cytologischonderzoekdiversen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cytologischonderzoekdiversen' ])
    ...
    with process_scenario_object.buikoverzichtstaand_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buikoverzichtstaand() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buikoverzichtstaand' ])

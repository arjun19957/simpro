def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.echomamma_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echomamma() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echomamma' ])

    with process_scenario_object.echogeleidealsassbijpunctiebiopsie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echogeleidealsassbijpunctiebiopsie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echogeleidealsassbijpunctiebiopsie' ])
    ...
    with process_scenario_object.ovariumredebulkingovariumcarcin_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ovariumredebulkingovariumcarcin() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ovariumredebulkingovariumcarcin' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.gipskamerokgebruik_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.gipskamerokgebruik() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'gipskamerokgebruik' ])

    with process_scenario_object.schoudergewricht_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.schoudergewricht() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'schoudergewricht' ])

    with process_scenario_object.bovenarm_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.bovenarm() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'bovenarm' ])
    ...
    with process_scenario_object.standaardmateriaalnno_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.standaardmateriaalnno() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'standaardmateriaalnno' ])

    with process_scenario_object.zwachtelverbandslingaanleggen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.zwachtelverbandslingaanleggen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'zwachtelverbandslingaanleggen' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.intercconsultvervolgklinischinterne_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultvervolgklinischinterne() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultvervolgklinischinterne' ])
    ...
    with process_scenario_object.anesthesiebijvervoerbeademdepatie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.anesthesiebijvervoerbeademdepatie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'anesthesiebijvervoerbeademdepatie' ])
    ...
    with process_scenario_object.cvvhdcontinuevenoveneuzehemo_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cvvhdcontinuevenoveneuzehemo() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cvvhdcontinuevenoveneuzehemo' ])
    ...
    with process_scenario_object.intensivecareligdagetotenmet_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intensivecareligdagetotenmet() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intensivecareligdagetotenmet' ])

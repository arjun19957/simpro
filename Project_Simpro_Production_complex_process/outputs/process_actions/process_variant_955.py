def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.dikkedarmresectiesigmoidmetprima_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.dikkedarmresectiesigmoidmetprima() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'dikkedarmresectiesigmoidmetprima' ])

    with process_scenario_object.dikkedarmappendectomienno_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.dikkedarmappendectomienno() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'dikkedarmappendectomienno' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.mecabepalingvoormrsambvpcr_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.mecabepalingvoormrsambvpcr() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'mecabepalingvoormrsambvpcr' ])
    ...
    with process_scenario_object.vaginaextirpatievanvaginamet_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.vaginaextirpatievanvaginamet() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'vaginaextirpatievanvaginamet' ])

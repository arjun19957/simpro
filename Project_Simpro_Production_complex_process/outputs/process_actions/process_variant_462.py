def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.perifvatendoppleronderzoppervlven_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.perifvatendoppleronderzoppervlven() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'perifvatendoppleronderzoppervlven' ])

    with process_scenario_object.perifvatenduplexscanarterieelcruro_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.perifvatenduplexscanarterieelcruro() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'perifvatenduplexscanarterieelcruro' ])
    ...
    with process_scenario_object.buiksecondlookoperstagering_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buiksecondlookoperstagering() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buiksecondlookoperstagering' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.emgelektromyografischonderzo_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.emgelektromyografischonderzo() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'emgelektromyografischonderzo' ])
    ...
    with process_scenario_object.gemcitabine_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.gemcitabine() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'gemcitabine' ])

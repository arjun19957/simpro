def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.behandeleninhyperpressietank_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.behandeleninhyperpressietank() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'behandeleninhyperpressietank' ])
    ...
    with process_scenario_object.coloninloop_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.coloninloop() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'coloninloop' ])
    ...
    with process_scenario_object.elutievanautoantistoffentegenerytro_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.elutievanautoantistoffentegenerytro() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'elutievanautoantistoffentegenerytro' ])
    ...
    with process_scenario_object.gebantistoffentegenerysdircoombs_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.gebantistoffentegenerysdircoombs() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'gebantistoffentegenerysdircoombs' ])
    ...
    with process_scenario_object.opspuitenhickmankatheter_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.opspuitenhickmankatheter() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'opspuitenhickmankatheter' ])
    ...
    with process_scenario_object.uretersplintografiecqopspuitenuret_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.uretersplintografiecqopspuitenuret() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'uretersplintografiecqopspuitenuret' ])

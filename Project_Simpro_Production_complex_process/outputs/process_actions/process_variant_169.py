def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.heparineantixa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.heparineantixa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'heparineantixa' ])

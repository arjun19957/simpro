def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.uteruscurettagediagnostisch_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.uteruscurettagediagnostisch() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'uteruscurettagediagnostisch' ])

    with process_scenario_object.cervixcurettage_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.cervixcurettage() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'cervixcurettage' ])
    ...
    with process_scenario_object.buikstaglaparotomomentect_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.buikstaglaparotomomentect() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'buikstaglaparotomomentect' ])
    ...
    with process_scenario_object.echotractusurogenitalisbekken_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.echotractusurogenitalisbekken() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'echotractusurogenitalisbekken' ])
    ...
    with process_scenario_object.eiwitcolorimetrischtotaal_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.eiwitcolorimetrischtotaal() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'eiwitcolorimetrischtotaal' ])

    with process_scenario_object.microalbumineimmunonefelometrisch_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.microalbumineimmunonefelometrisch() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'microalbumineimmunonefelometrisch' ])
    ...
    with process_scenario_object.aluminium_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.aluminium() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'aluminium' ])

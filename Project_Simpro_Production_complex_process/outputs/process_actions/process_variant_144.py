def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.ctleverengalwegen_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.ctleverengalwegen() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'ctleverengalwegen' ])
    ...
    with process_scenario_object.mriorbita_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.mriorbita() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'mriorbita' ])

def action_plan(entity, process_scenario_object):
    ...
    with process_scenario_object.intercconsultklinischreumatologie_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.intercconsultklinischreumatologie() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'intercconsultklinischreumatologie' ])
    ...
    with process_scenario_object.antiepsteinbarrvcaigmmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antiepsteinbarrvcaigmmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antiepsteinbarrvcaigmmbvelisa' ])

    with process_scenario_object.antiepsteinbarrnaiggmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antiepsteinbarrnaiggmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antiepsteinbarrnaiggmbvelisa' ])

    with process_scenario_object.antiepsteinbarrvcaiggmbvelisa_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.antiepsteinbarrvcaiggmbvelisa() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'antiepsteinbarrvcaiggmbvelisa' ])
    ...
    with process_scenario_object.complementcomponentckwn_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.complementcomponentckwn() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'complementcomponentckwn' ])
    ...
    with process_scenario_object.dnafarrassaymbvria_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.dnafarrassaymbvria() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'dnafarrassaymbvria' ])
    ...
    with process_scenario_object.legionellaantigeensneltest_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.legionellaantigeensneltest() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'legionellaantigeensneltest' ])
    ...
    with process_scenario_object.complementdeficientieondbijafwezigha_resource.request() as request:
        yield request
        yield process_scenario_object.env.process( process_scenario_object.complementdeficientieondbijafwezigha() )
        process_scenario_object.log_list.append([entity, process_scenario_object.env.now, 'complementdeficientieondbijafwezigha' ])
